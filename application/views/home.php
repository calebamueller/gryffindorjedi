...
<!--        <link rel=stylesheet href="<?//php echo base_url('assets/css/homeStyle.css')?>">-->
                <link rel=stylesheet href="gryffindorjedi/applications/views/assets/css/homeStyle.css">
...
<!--        <link rel="stylesheet" href="<?//php base_url('..css/style.css')?>">-->
        <link rel="stylesheet" href="gryffindorjedi/application/views/assets/css/style.css">
...
<!--        <script src="<?php //echo base_url('assets/js/angular.js')?>"></script>-->
        <script src="gryffindorjedi/application/views/assets/js/main.js"></script>
