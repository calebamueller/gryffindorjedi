        ...
        <div id="top" ng-controller="PeopleCtrl"><?php $count=2;?>
          <div ng-repeat="person in people">
            ...
            <div class="col-sm-4 item" id="item">
              ...
              <button ng-controller="ClassCtrl" class='btn-default' id='{{person.class1.class_id}}{{person.class2.class_id}}{{person.class3.class_id}}{{person.class4.class_id}}' ng-click="createUrl($event); go('/class')">Enter Class</button>
