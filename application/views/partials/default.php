        ...
        <div id="top" ng-controller="PeopleCtrl"><?php $count=2;?>
          <div ng-repeat="person in people">
            ...
            <div class="col-sm-4 item" id="item">
              ...
              <button class='btn-default' id='{{person.class1.class_name}}{{person.class2.class_name}}{{person.class3.class_name}}{{person.class4.class_name}}' ng-click='getClass({{person.class1.class_name}}{{person.class2.class_name}}{{person.class3.class_name}}{{person.class4.class_name}})'><a href='#/class'>Button</a></button>
